...
const outputPath = path.join(pluginRoot, 'resources', 'preview-final.png');
...
const tempHtml = path.join(dataDir, 'preview_final.html');
...
(async () => {
  ...
  console.log('viewport调整后 boundingBox:', JSON.stringify(box2));
